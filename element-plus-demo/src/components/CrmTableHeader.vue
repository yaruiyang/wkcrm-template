    ...
    <div class="wk-filter-header">
      <div class="filter-wrap">
        ...
        <div class="filter-right">
          <el-button text bg class="filter-button" @click="$emit('advanced-filter')"><el-icon><Filter /></el-icon><span>高级筛选</span></el-button>
...
import { ArrowDown, Close, Filter, Grid, Menu, Operation, Search } from '@element-plus/icons-vue'
...
const visibleScenes = computed(() => props.sceneList.slice(0, wkcrmUiDimensions.maxVisibleSceneCount))
const overflowScenes = computed(() => props.sceneList.slice(wkcrmUiDimensions.maxVisibleSceneCount))
